...
#include "Phronesis/Graphics/Shader.hpp"
#include "Phronesis/Graphics/RenderUtils.hpp"
#include "Phronesis/Graphics/Vertex.hpp"
#include "Phronesis/Graphics/UniformBufferObject.hpp"
...
{
	Module::getModule<Window>()->handleMinimize();
